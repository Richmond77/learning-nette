...
class Container_6d638b6f83 extends Nette\DI\Container
{
	protected $meta = array(
		'types' => array(
			...
			'KdybyModule\CliPresenter' => array(array('application.6')),
	...
	{
		$service = new Nette\Application\PresenterFactory(new Nette\Bridges\ApplicationDI\PresenterFactoryCallback($this, 5, '/home/richmond/vhosts/nette-test/sandbox/app/../temp/cache/Nette%5CBridges%5CApplicationDI%5CApplicationExtension'));
	...
	{
		$service = new Nette\Database\Connection('mysql:host=127.0.0.1;dbname=quickstart', 'root', 'daryl', array('lazy' => TRUE));
	...
	{
		return new Container_6d638b6f83_Kdyby_Doctrine_EntityDaoFactoryImpl_doctrine_daoFactory($this);
	}
	...
	{
		return new Container_6d638b6f83_Kdyby_Doctrine_DI_IRepositoryFactoryImpl_doctrine_repositoryFactory_default_defaultRepositoryFactory($this);
	}
	...
	{
		return new Container_6d638b6f83_Nette_Bridges_ApplicationLatte_ILatteFactoryImpl_latte_latteFactory($this);
	}
...
final class Container_6d638b6f83_Kdyby_Doctrine_EntityDaoFactoryImpl_doctrine_daoFactory implements Kdyby\Doctrine\EntityDaoFactory
{
	private $container;


	public function __construct(Container_6d638b6f83 $container)
	{
...
final class Container_6d638b6f83_Kdyby_Doctrine_DI_IRepositoryFactoryImpl_doctrine_repositoryFactory_default_defaultRepositoryFactory implements Kdyby\Doctrine\DI\IRepositoryFactory
{
	private $container;
...
final class Container_6d638b6f83_Nette_Bridges_ApplicationLatte_ILatteFactoryImpl_latte_latteFactory implements Nette\Bridges\ApplicationLatte\ILatteFactory
{
	private $container;
