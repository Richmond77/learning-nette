...
class Container_110061dd0c extends Nette\DI\Container
{
	protected $meta = array(
		'types' => array(
			'Nette\Object' => array(
				array(
					...
					'69_App_Forms_SignFormFactory',
					'70_App_Model_UserManager',
					'application.1',
					'application.2',
					'application.3',
					'application.4',
			...
			'App\Forms\SignFormFactory' => array(
				1 => array('69_App_Forms_SignFormFactory'),
			),
			'Nette\Security\IAuthenticator' => array(1 => array('70_App_Model_UserManager')),
			'App\Model\UserManager' => array(1 => array('70_App_Model_UserManager')),
		...
		'services' => array(
			'69_App_Forms_SignFormFactory' => 'App\Forms\SignFormFactory',
			'70_App_Model_UserManager' => 'App\Model\UserManager',
	 ...
	 */
	public function createService__69_App_Forms_SignFormFactory()
	{
	 ...
	 */
	public function createService__70_App_Model_UserManager()
	{
	...
	public function createServiceApplication__2()
	{
		...
		$service->factory = $this->getService('69_App_Forms_SignFormFactory');
	...
	{
		return new Container_110061dd0c_Kdyby_Doctrine_EntityDaoFactoryImpl_doctrine_daoFactory($this);
	}
	...
	{
		return new Container_110061dd0c_Kdyby_Doctrine_DI_IRepositoryFactoryImpl_doctrine_repositoryFactory_default_defaultRepositoryFactory($this);
	}
	...
	{
		return new Container_110061dd0c_Nette_Bridges_ApplicationLatte_ILatteFactoryImpl_latte_latteFactory($this);
	}
	...
	{
		$service = new Nette\Security\User($this->getService('security.userStorage'), $this->getService('70_App_Model_UserManager'));
...
final class Container_110061dd0c_Kdyby_Doctrine_EntityDaoFactoryImpl_doctrine_daoFactory implements Kdyby\Doctrine\EntityDaoFactory
{
	private $container;


	public function __construct(Container_110061dd0c $container)
	{
...
final class Container_110061dd0c_Kdyby_Doctrine_DI_IRepositoryFactoryImpl_doctrine_repositoryFactory_default_defaultRepositoryFactory implements Kdyby\Doctrine\DI\IRepositoryFactory
{
	private $container;
...
final class Container_110061dd0c_Nette_Bridges_ApplicationLatte_ILatteFactoryImpl_latte_latteFactory implements Nette\Bridges\ApplicationLatte\ILatteFactory
{
	private $container;
